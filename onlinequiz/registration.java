...
//        login.setFont(new Font("tahome", Font.BOLD, 15));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == registerButton) {
            String Name = txtfieldname.getText();
            String Regno = txtfieldregno.getText();
            ...
            try {
                ...
                String query = "insert into registration values('" + Name + "', '" + Regno + "', '" + Email + "', '" + Password + "', '" + Degree + "','" + District + "','" + State + "')";
                String query1 = "insert into Login values('" + Regno + "','" + Password + "')";
